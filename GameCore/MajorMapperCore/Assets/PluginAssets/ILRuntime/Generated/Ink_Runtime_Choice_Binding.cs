...
{
    unsafe class Ink_Runtime_Choice_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Ink.Runtime.Choice);
            args = new Type[]{};
        ...
        static StackObject* get_text_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Ink.Runtime.Choice instance_of_this_method = (Ink.Runtime.Choice)typeof(Ink.Runtime.Choice).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
