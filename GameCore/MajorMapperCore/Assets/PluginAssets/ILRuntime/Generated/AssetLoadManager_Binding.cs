...
{
    unsafe class AssetLoadManager_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::AssetLoadManager);
            ...
            app.RegisterCLRMethodRedirection(method, UnLoadAssetBundle_1);
            ...
            app.RegisterCLRMethodRedirection(method, OnDispose_3);
            args = new Type[]{typeof(System.String), typeof(System.String), typeof(System.Boolean)};
            method = type.GetMethod("LoadLevelAsync", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, LoadLevelAsync_4);
        ...
        static StackObject* LoadAsset_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = global::AssetLoadManager.LoadAsset<UnityEngine.GameObject>(@assetBundleName, @assetName);

            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static StackObject* UnLoadAssetBundle_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            global::AssetLoadManager.UnLoadAssetBundle(@assetBundleName);
        ...
        static StackObject* LoadAsset_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = global::AssetLoadManager.LoadAsset<UnityEngine.TextAsset>(@assetBundleName, @assetName);

            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static StackObject* OnDispose_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);


            global::AssetLoadManager.OnDispose();

            return __ret;
        }

        static StackObject* LoadLevelAsync_4(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            var result_of_this_method = global::AssetLoadManager.LoadLevelAsync(@assetBundleName, @levelName, @isAdditive);
