...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Physics2D_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, OverlapCircleAll_0);


        }


        static StackObject* OverlapCircleAll_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
